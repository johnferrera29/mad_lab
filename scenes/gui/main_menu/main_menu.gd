...
var _menu_clicked_audio_resource := preload("res://shared_resources/audio/menu_item_clicked.ogg")

@onready var _continue_button := $VBoxContainer/ContinueButton as Button
@onready var _audio_queue := $MenuFocusAudioQueue as AudioQueue
...
func _on_new_game_button_pressed() -> void:
	...
	# Start from Level 1
	AudioManager.play_sound(_menu_clicked_audio_resource)
